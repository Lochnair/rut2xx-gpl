...
# Flush all zone_port_scan rules
iptables --flush zone_port_scan
# Delete jumps created in filter
iptables -t filter --delete zone_wan_forward -j zone_port_scan
iptables -t filter --delete zone_wan_input -j zone_port_scan
# Delete the chain itself
iptables --delete-chain zone_port_scan
