...
int main(int argc, char **argv) {
  ...
  _options.defmaxinputoctets = args_info.defmaxinputoctets_arg;
  _options.defmaxoutputoctets = args_info.defmaxoutputoctets_arg;
  _options.defdatainterval = args_info.defdatainterval_arg;
  _options.defstartpoint = args_info.defstartpoint_arg;
  _options.smsotpmode = args_info.smsotpmode_arg;
  _options.macmode = args_info.macmode_arg;
  ...
  _options.redirect = args_info.redirect_flag;
#ifdef ENABLE_UAMANYIP
  ...
  */
  ...
  _options.successurl = STRDUP(args_info.successurl_arg);
  ...
  _options.mansystem = STRDUP(args_info.mansystem_arg);
  ...
  _options.hotspotid = STRDUP(args_info.hotspotid_arg);
