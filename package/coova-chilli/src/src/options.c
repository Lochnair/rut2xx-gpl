...
int options_fromfd(int fd, bstring bt) {
  ...
  if (!option_s_l(bt, &o.hotspotid)) return 0;
  ...
  if (!option_s_l(bt, &o.successurl)) return 0;
#ifdef HAVE_SSL
...
int options_save(char *file, bstring bt) {
  ...
  if (!option_s_s(bt, &o.hotspotid)) return 0;
  ...
  if (!option_s_s(bt, &o.successurl)) return 0;
#ifdef HAVE_SSL
