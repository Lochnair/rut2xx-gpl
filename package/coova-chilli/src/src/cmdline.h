...
struct gengetopt_args_info
{
  ...
  const char *condown_help; /**< @brief Script to run after user logoff help description.  */
	char * hotspotid_arg;	/**< @brief Script to run after user logoff.  */
  char * hotspotid_orig;	/**< @brief Script to run after user logoff original value given at command line.  */
  const char *hotspotid_help; /**< @brief Script to run after user logoff help description.  */
  ...
  int redirect_flag;	/**< @brief Redirect to first acessed page after authentication. (default=on).  */
  const char *redirect_help; /**< @brief Redirect to first acessed page after authentication.  */
  ...
  long defmaxinputoctets_arg;	/**< @brief Default WISPr-Bandwidth-Max-Down if not returned by RADIUS (default='0').  */
  char * defmaxinputoctets_orig;	/**< @brief Default WISPr-Bandwidth-Max-Down if not returned by RADIUS original value given at command line.  */
  const char *defmaxinputoctets_help; /**< @brief Default WISPr-Bandwidth-Max-Down if not returned by RADIUS help description.  */
  long defmaxoutputoctets_arg;	/**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS (default='0').  */
  char * defmaxoutputoctets_orig;	/**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS original value given at command line.  */
  const char *defmaxoutputoctets_help; /**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS help description.  */
  long defdatainterval_arg;	/**< @brief Default WISPr-Bandwidth-Max-Down if not returned by RADIUS (default='0').  */
  char * defdatainterval_orig;	/**< @brief Default WISPr-Bandwidth-Max-Down if not returned by RADIUS original value given at command line.  */
  const char *defdatainterval_help; /**< @brief Default WISPr-Bandwidth-Max-Down if not returned by RADIUS help description.  */
  long defstartpoint_arg;	/**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS (default='0').  */
  char * defstartpoint_orig;	/**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS original value given at command line.  */
  const char *defstartpoint_help; /**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS help description.  */
  long smsotpmode_arg;	/**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS (default='0').  */
  char * smsotpmode_orig;	/**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS original value given at command line.  */
  const char *smsotpmode_help; /**< @brief Default WISPr-Bandwidth-Max-Up if not returned by RADIUS help description.  */
  long macmode_arg;	/**< @brief   */
  char * macmode_orig;	/**< @brief   */
  const char *macmode_help; /**< @brief   */
  ...
  char * localusers_orig;	/**< @brief File keep 'Local' usernames and passwords original value given at command line.  */
	char * successurl_arg;	/**< @brief Address to redirect after successful authentication.  */
  char * successurl_orig;	/**< @brief Address to redirect after successful authentication.  */
  const char *localusers_help; /**< @brief File keep 'Local' usernames and passwords help description.  */
  const char *successurl_help; /**< @brief Address to redirect after successful authentication  */
  ...
  char * mansystem_arg;	/**< @brief TUN/TAP Device, as in tun0 or tap1.  */
  char * mansystem_orig;	/**< @brief TUN/TAP Device, as in tun0 or tap1 original value given at command line.  */
  const char *mansystem_help; /**< @brief TUN/TAP Device, as in tun0 or tap1 help description.  */
  ...
  unsigned int redirect_given ;	/**< @brief Whether redirect was given.  */
  ...
  unsigned int defmaxoutputoctets_given ;	/**< @brief Whether defmaxoutputoctets was given.  */
  unsigned int defmaxinputoctets_given ;	/**< @brief Whether defmaxinputoctets was given.  */
  unsigned int defdatainterval_given ;	/**< @brief Whether defdatainterval was given.  */
  unsigned int defstartpoint_given ;	/**< @brief Whether defstartpoint was given.  */
  unsigned int smsotpmode_given ;	/**< @brief Whether smsotpmode was given.  */
  unsigned int macmode_given ;	/**< @brief Whether macmode was given.  */
  ...
  unsigned int successurl_given ;	/**< @brief Success auth url  */
  ...
  unsigned int mansystem_given ;	/**< @brief Whether mansystem was given.  */
	unsigned int hotspotid_given ;	/**< @brief Whether hotspotid was given.  */
