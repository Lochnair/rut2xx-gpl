...
const char *gengetopt_args_info_help[] = {
  ...
  "      --redirect                Redirect to first page after successful authentication  \n                                  (default=off)",
  ...
  "      --successurl=STRING       Address to redirect after successful authentication",
  ...
  "      --mansystem=STRING        Hotspot management system (Cloud4wi, Hotspotsystem default=none)",
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->defmaxinputoctets_given = 0 ;
  args_info->defmaxoutputoctets_given = 0 ;
  args_info->defdatainterval_given = 0 ;
  args_info->defstartpoint_given = 0 ;
  args_info->smsotpmode_given = 0 ;
  args_info->macmode_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->hotspotid_arg = NULL;
  args_info->hotspotid_orig = NULL;
  ...
  args_info->mansystem_arg = NULL;
  args_info->mansystem_orig = NULL;
  ...
  args_info->defmaxinputoctets_arg = 0;
  args_info->defmaxinputoctets_orig = NULL;
  args_info->defmaxoutputoctets_arg = 0;
  args_info->defmaxoutputoctets_orig = NULL;
  args_info->defdatainterval_arg = 0;
  args_info->defdatainterval_orig = NULL;
  args_info->defstartpoint_arg = 0;
  args_info->defstartpoint_orig = NULL;
  args_info->smsotpmode_arg = 0;
  args_info->smsotpmode_orig = NULL;
  args_info->macmode_arg = 0;
  args_info->macmode_orig = NULL;
  ...
  args_info->successurl_arg = NULL;
  args_info->successurl_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->defmaxinputoctets_help = gengetopt_args_info_help[114] ;
  args_info->defmaxoutputoctets_help = gengetopt_args_info_help[115] ;
  args_info->defdatainterval_help = gengetopt_args_info_help[115] ;
  args_info->defstartpoint_help = gengetopt_args_info_help[115] ;
  args_info->smsotpmode_help = gengetopt_args_info_help[115] ;
  ...
  args_info->macmode_help = gengetopt_args_info_help[205] ;
  args_info->redirect_help = gengetopt_args_info_help[206] ;
  args_info->mansystem_help = gengetopt_args_info_help[207] ;
  args_info->successurl_help = gengetopt_args_info_help[208] ;
  args_info->hotspotid_help = gengetopt_args_info_help[209] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->hotspotid_arg));
  free_string_field (&(args_info->hotspotid_orig));
  ...
  free_string_field (&(args_info->mansystem_arg));
  free_string_field (&(args_info->mansystem_orig));
  ...
  free_string_field (&(args_info->defmaxinputoctets_orig));
  free_string_field (&(args_info->defmaxoutputoctets_orig));
  free_string_field (&(args_info->defdatainterval_orig));
  free_string_field (&(args_info->defstartpoint_orig));
  free_string_field (&(args_info->smsotpmode_orig));
  free_string_field (&(args_info->macmode_orig));
  ...
  free_string_field (&(args_info->successurl_arg));
  free_string_field (&(args_info->localusers_orig));
  free_string_field (&(args_info->successurl_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->mansystem_given)
    write_into_file(outfile, "mansystem", args_info->mansystem_orig, 0);
  ...
  if (args_info->redirect_given)
    write_into_file(outfile, "redirect", 0, 0 );
  ...
  if (args_info->defmaxinputoctets_given)
    write_into_file(outfile, "defmaxinputoctets", args_info->defmaxinputoctets_orig, 0);
  if (args_info->defmaxoutputoctets_given)
    write_into_file(outfile, "defmaxoutputoctets", args_info->defmaxoutputoctets_orig, 0);
  if (args_info->defdatainterval_given)
    write_into_file(outfile, "defdatainterval", args_info->defdatainterval_orig, 0);
  if (args_info->defstartpoint_given)
    write_into_file(outfile, "defstartpoint", args_info->defstartpoint_orig, 0);
  if (args_info->smsotpmode_given)
    write_into_file(outfile, "smsotpmode", args_info->smsotpmode_orig, 0);
  if (args_info->macmode_given)
    write_into_file(outfile, "macmode", args_info->macmode_orig, 0);
  ...
  if (args_info->successurl_given)
    write_into_file(outfile, "successurl", args_info->successurl_orig, 0);
  ...
  if (args_info->hotspotid_given)
    write_into_file(outfile, "hotspotid", args_info->hotspotid_orig, 0);
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
	...
	{ "defmaxinputoctets",	1, NULL, 0 },
        { "defmaxoutputoctets",	1, NULL, 0 },
	{ "defdatainterval",	1, NULL, 0 },
        { "defstartpoint",	1, NULL, 0 },
	{ "smsotpmode",	1, NULL, 0 },
	{ "macmode",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "mansystem") == 0)
          {


            if (update_arg( (void *)&(args_info->mansystem_arg),
                 &(args_info->mansystem_orig), &(args_info->mansystem_given),
                &(local_args_info.mansystem_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "mansystem", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "redirect") == 0)
          {


            if (update_arg((void *)&(args_info->redirect_flag), 0, &(args_info->redirect_given),
                &(local_args_info.redirect_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "redirect", '-',
                additional_error))
              goto failure;
          ...
          /* Default ChilliSpot-Max-Input-Octets if not returned by RADIUS.  */
          else if (strcmp (long_options[option_index].name, "defmaxinputoctets") == 0)
          {


            if (update_arg( (void *)&(args_info->defmaxinputoctets_arg),
                 &(args_info->defmaxinputoctets_orig), &(args_info->defmaxinputoctets_given),
                &(local_args_info.defmaxinputoctets_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "defmaxinputoctets", '-',
                additional_error))
              goto failure;
          ...
          /* Default ChilliSpot-Max-Output-Octets if not returned by RADIUS.  */
          else if (strcmp (long_options[option_index].name, "defmaxoutputoctets") == 0)
          {


            if (update_arg( (void *)&(args_info->defmaxoutputoctets_arg),
                 &(args_info->defmaxoutputoctets_orig), &(args_info->defmaxoutputoctets_given),
                &(local_args_info.defmaxoutputoctets_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "defmaxoutputoctets", '-',
                additional_error))
              goto failure;
          ...
          /* Default data interval if not returned by RADIUS.  */
          else if (strcmp (long_options[option_index].name, "defdatainterval") == 0)
          {
            if (update_arg( (void *)&(args_info->defdatainterval_arg),
                 &(args_info->defdatainterval_orig), &(args_info->defdatainterval_given),
                &(local_args_info.defdatainterval_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "defdatainterval", '-',
                additional_error))
              goto failure;
          ...
          /* Default start point if not returned by RADIUS.  */
          else if (strcmp (long_options[option_index].name, "defstartpoint") == 0)
          {
            if (update_arg( (void *)&(args_info->defstartpoint_arg),
                 &(args_info->defstartpoint_orig), &(args_info->defstartpoint_given),
                &(local_args_info.defstartpoint_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "defstartpoint", '-',
                additional_error))
              goto failure;
          ...
          /* Default start point if not returned by RADIUS.  */
          else if (strcmp (long_options[option_index].name, "smsotpmode") == 0)
          {
            if (update_arg( (void *)&(args_info->smsotpmode_arg),
                 &(args_info->smsotpmode_orig), &(args_info->smsotpmode_given),
                &(local_args_info.smsotpmode_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "smsotpmode", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "macmode") == 0)
          {
            if (update_arg( (void *)&(args_info->macmode_arg),
                 &(args_info->macmode_orig), &(args_info->macmode_given),
                &(local_args_info.macmode_given), optarg, 0, "0", ARG_LONG,
                check_ambiguity, override, 0, 0,
                "macmode", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "successurl") == 0)
          {


            if (update_arg( (void *)&(args_info->successurl_arg),
                 &(args_info->successurl_orig), &(args_info->successurl_given),
                &(local_args_info.successurl_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "successurl", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "hotspotid") == 0)
          {


            if (update_arg( (void *)&(args_info->hotspotid_arg),
                            &(args_info->hotspotid_orig), &(args_info->hotspotid_given),
                            &(local_args_info.hotspotid_given), optarg, 0, 0, ARG_STRING,
                            check_ambiguity, override, 0, 0,
                            "hotspotid", '-',
                            additional_error))
              goto failure;
