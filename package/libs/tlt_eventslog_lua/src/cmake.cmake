...
SET_PROJECT(tlt_eventslog_lua)

COMPILE_LIB(tlt_eventslog_lua shared "tlt_eventslog_lua.c")
DEFINE(tlt_eventslog_lua "LUA_USE_POSIX;LUA_USE_DLOPEN")
INCLUDE_DIR("include")
ADD_LIB("lua;eventslog")
SET_CFLAGS("-O2 -fPIC -I/usr/include/lua5.1")
