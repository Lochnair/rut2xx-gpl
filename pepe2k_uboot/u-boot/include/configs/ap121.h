...
#elif defined(CONFIG_FOR_TLT_RUT200)
	#define GPIO_LED_2G_BIT 8
	#define GPIO_LED_3G_BIT 24
	#define GPIO_LED_4G_BIT 21
	#define GPIO_LED1_BIT 23
	#define GPIO_LED2_BIT 7
	#define GPIO_LED3_BIT 6
	#define GPIO_LED4_BIT 26
	#define GPIO_LED5_BIT 27
	#define GPIO_LED_LAN_BIT 13
	#define GPIO_LED_WAN_BIT 14
	#define GPIO_DIGITAL_IN  16

	#define OFFSET_MNF_INFO 	0x20000
	#define OFFSET_SERIAL_NUMBER 	0x00030
	#define SERIAL_NUMBER_LENGTH 	0x0000A

	//#define CONFIG_QCA_GPIO_MASK_LED_ACT_H	
	#define CONFIG_QCA_GPIO_MASK_LED_ACT_L	GPIO13 | GPIO14 | GPIO6 | GPIO7 | GPIO8 | GPIO21 | GPIO23 | GPIO24 | GPIO26 | GPIO27
	#define CONFIG_QCA_GPIO_MASK_OUT	GPIO12 | CONFIG_QCA_GPIO_MASK_LED_ACT_L /*|\
						CONFIG_QCA_GPIO_MASK_LED_ACT_H*/
 ...
 */
...
#elif defined(CONFIG_FOR_TLT_RUT200)
	#define	CONFIG_BOOTARGS	"console=ttyS0,115200 root=31:02 rootfstype=squashfs init=/sbin/init mtdparts=ar7240-nor0:128k(u-boot),64k(config),64k(ART),1024k(kernel),2816k(rootfs)"
	...
	#define CONFIG_BOOTARGS	"console=ttyS0,115200 root=31:02 "\
				"rootfstype=squashfs init=/sbin/init "\
				"mtdparts=ar7240-nor0:128k(u-boot),64k(config),64k(art),1024k(kernel),2816k(rootfs)"
...
#if !defined(CONFIG_FOR_TLT_RUT200)             &&\
