...
extra_file_name_info = sft:option( ListValue, "extra_name_info", translate("File name extras"), translate("Extra information to be added to file name"))
extra_file_name_info:value( "none", translate("No extra information" ))
extra_file_name_info:value( "mac", translate("Mac address" ))
extra_file_name_info:value( "serial", translate("Serial number" ))
extra_file_name_info:value( "custom", translate("Custom string" ))

custom_string = sft:option( Value, "custom_string", translate("Custom string" ), translate("Custom string to be added to ftp file name"))
custom_string:depends( "extra_name_info", "custom" )
custom_string.datatype = "fieldvalidation('^[a-zA-Z0-9_+.\-]+$',0)"
