...
local psk = keys:option( Value, "psk_key", translate("Pre-shared key"), translate("A shared password to authenticate between the peers."))
	psk.noautocomplete = true
	psk.password = true
	psk.datatype = "fieldvalidation('^[^ \"]*$',0)"
