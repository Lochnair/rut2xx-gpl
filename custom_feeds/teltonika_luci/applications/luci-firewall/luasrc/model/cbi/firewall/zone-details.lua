...
--~ s = m:section(NamedSection, zone.sid, "zone",
	...
	--~ translatef("This section defines common properties of %q.", zone:name()))
...
s2 = m:section(NamedSection, zone.sid, "fwd_out",
	translate("Zone Forwarding"),
	escapeHTML(translatef("The options below control the forwarding policies between zone (%s) and other zones. Destination zones gets forwarded traffic originating from %q.",
...
out.nocreate = true
out.widget = "checkbox"
out.exclude = escapeHTML(zone:name())
