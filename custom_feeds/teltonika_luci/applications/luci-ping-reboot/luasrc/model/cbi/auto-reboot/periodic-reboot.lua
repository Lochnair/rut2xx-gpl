...
v = s:option(ListValue, "action", translate("Action"), translate("Action to take on selected days"))
v.template = "auto-reboot/lvalue"
v.default = "1"
v:value("1", "Reboot")
v:value("2", "Modem restart")

day = s:option(StaticList, "day", translate("Days"), translate("Periodic reboot will be performed on selected days"))
...
t = s:option(Value, "hours", translate("Hours"), translate("Periodic reboot will be performed at this hour. Range [0 - 23]"))
t.default = "23"
t.datatype = "range(0,23)"

-- period interval min
t = s:option(Value, "minutes", translate("Minutes"), translate("Periodic reboot will be performed at this minute. Range [0 - 59]"))
t.default = "0"
