...
user = s:option(Value, "username", translate("Username"), translate("Specify username for authentication"))
user.datatype = "fieldvalidation('^[a-zA-Z0-9!@#$%%^&*+=?_.-]+$',5)"

pass = s:option(Value, "password", translate("Password"), translate("Specify password of a username"))
pass.datatype = "fieldvalidation('^[a-zA-Z0-9!@#$%%^&*+=?_.-]+$',5)"
