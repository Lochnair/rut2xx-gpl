...
outputt = s:option(Value, "startdelay", translate("Start delay, s"), translate("Output will be ativated after this many seconds after trigger"))
outputt:depends( "continuous", "2")
outputt:depends( "continuous", "2")
outputt.datatype = "uinteger"

outputt = s:option(Value, "stopdelay", translate("Stop delay, s"), translate("Output will be deativated after this many seconds after trigger stops"))
outputt:depends("continuous", "2")
outputt:depends("continuous", "2")
outputt.datatype = "uinteger"
