...
function index()
	entry({"admin", "system", "licenses"}, alias("admin", "system", "licenses","general_info"), _("Licenses"), 7)
        entry({"admin", "system", "licenses","general_info"}, template("admin_licenses/general_info"), _("General Info"), 1).leaf = true
        ...
        entry({"admin", "system", "licenses","lgplv2"}, template("admin_licenses/LGPLv2-1"), _("LGPLv2.1"), 4).leaf = true
        ...
        entry({"admin", "system", "licenses","openssl"}, template("admin_licenses/OpenSSL"), _("OpenSSL"), 10).leaf = true
