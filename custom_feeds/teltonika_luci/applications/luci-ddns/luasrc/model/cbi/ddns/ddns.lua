...
dummy.default = translate("Private, Custom or Script IP source setting, will disable DNS rebinding protection")
dummy:depends("ipv4_source", "network")
dummy:depends("ipv4_source", "interface")
dummy:depends("ipv4_source", "script")
