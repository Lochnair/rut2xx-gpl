...
o = s:option(Value, "smtpIP", translate("SMTP server"), translate("SMTP (Simple Mail Transfer Protocol) server."))
o:depends("type", "Email")
o.datatype = "host"
...
o = s:option(Value, "host", translate("Host"), translate("FTP (File Transfer Protocol) host name, e.g. ftp.example.com, 192.168.123.123"))
o:depends("type", "FTP")                                                                                                                
o.datatype = "host"
