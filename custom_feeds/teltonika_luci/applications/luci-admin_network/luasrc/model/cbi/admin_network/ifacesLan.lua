...
if has_dnsmasq and net:proto() == "static" and ( not bridge_mode or bridge_mode ~= "bridge") then
	...
	if not has_section then
		...
		s:taboption("advanced", Flag, "force", translate("Force DHCP server"),
			translate("Force DHCP server on this network even if another server is detected"))
		...
		s:taboption("advanced", Flag, "force_options", translate("Force DHCP options"),
			translate("Force DHCP option to be sent even if its not requested"))
