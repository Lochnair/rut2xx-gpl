...
function cbi_d_counter(id) {
	...
	document.getElementById("cbid.sms_utils.1.message").maxLength=480-countoflong;
	if (lengthtoshow > 480){

		document.getElementById("cbid.sms_utils.1.message").value = document.getElementById("cbid.sms_utils.1.message").value.substring(0,480-countoflong);
		value = value.substring(0,480-countoflong);
	}
