...
local ifc = interface
local ifname = interface:name() or ""
...
hostname = section:taboption("general", Value, "hostname", translate("Hostname to send when requesting DHCP"), translate("Specify hostname which will be sent when requesting DHCP (Dynamic Host Configuration Protocol)"))
