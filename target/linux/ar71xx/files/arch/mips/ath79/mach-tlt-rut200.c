/*
 *  Teltonika RUT200 board support
 *
...
#define TLT_RUT200_GPIO_BTN_RESET	22

#define TLT_RUT200_GPIO_LED_SS1	23
#define TLT_RUT200_GPIO_LED_SS2	7
#define TLT_RUT200_GPIO_LED_SS3	6
#define TLT_RUT200_GPIO_LED_SS4	26
#define TLT_RUT200_GPIO_LED_SS5	27

#define TLT_RUT200_GPIO_LED_2G		8
#define TLT_RUT200_GPIO_LED_3G		24
#define TLT_RUT200_GPIO_LED_4G		21

#define TLT_RUT200_GPIO_USB_POWER 19
#define TLT_RUT200_GPIO_BTN_SIM_HOLDER	20
#define TLT_RUT200_GPIO_BTN_INPUT	16

#define TLT_RUT200_KEYS_POLL_INTERVAL	20	/* msecs */
#define TLT_RUT200_KEYS_DEBOUNCE_INTERVAL (3 * TLT_RUT200_KEYS_POLL_INTERVAL)
...
static struct gpio_led tlt_rut200_leds_gpio[] __initdata = {
	{
		.name		= "signal_bar0",
		.gpio		= TLT_RUT200_GPIO_LED_SS1,
		.active_low	= 1,
	}, {
		.name		= "signal_bar1",
		.gpio		= TLT_RUT200_GPIO_LED_SS2,
		.active_low	= 1,
	}, {
		.name		= "signal_bar2",
		.gpio		= TLT_RUT200_GPIO_LED_SS3,
		.active_low	= 1,
	}, {
		.name		= "signal_bar3",
		.gpio		= TLT_RUT200_GPIO_LED_SS4,
		.active_low	= 1,
	}, {
		.name		= "signal_bar4",
		.gpio		= TLT_RUT200_GPIO_LED_SS5,
		.active_low	= 1,
	}, {
		.name		= "status_2g",
		.gpio		= TLT_RUT200_GPIO_LED_2G,
		.active_low	= 0,
	}, {
		.name		= "status_3g",
		.gpio		= TLT_RUT200_GPIO_LED_3G,
		.active_low	= 0,
	}, {
		.name		= "status_4g",
		.gpio		= TLT_RUT200_GPIO_LED_4G,
		.active_low	= 0,
	}, {
		.name		= "led_lan",
		.gpio		= 13,
...
static struct gpio_keys_button tlt_rut200_gpio_keys[] __initdata = {
	{
	 ...
	 .type = EV_KEY,
	 .code = KEY_RESTART,
	 .debounce_interval = TLT_RUT200_KEYS_DEBOUNCE_INTERVAL,
	 .gpio = TLT_RUT200_GPIO_BTN_RESET,
	 .active_low = 0,
	 },
	{
	 .desc = "input",
	 ...
	 .code = BTN_0,
	 .debounce_interval = TLT_RUT200_KEYS_DEBOUNCE_INTERVAL,
	 .gpio = TLT_RUT200_GPIO_BTN_INPUT,
	 .active_low = 1,
	 },
	{
	 .desc = "SIM holder",
	 ...
	 .code = KEY_RFKILL,
	 .debounce_interval = TLT_RUT200_KEYS_DEBOUNCE_INTERVAL,
	 .gpio = TLT_RUT200_GPIO_BTN_SIM_HOLDER,
	 .active_low = 1,
	 }
};
...
tlt_rut200_setup(void)
{
	...
	ath79_register_gpio_keys_polled(1, TLT_RUT200_KEYS_POLL_INTERVAL, ARRAY_SIZE(tlt_rut200_gpio_keys), tlt_rut200_gpio_keys);

}

MIPS_MACHINE(ATH79_MACH_TLT_RUT200, "TLT-RUT200", "Teltonika RUT200", tlt_rut200_setup);
